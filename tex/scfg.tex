...
We can prove
$$ \tilde\alpha(v,a)=\frac{1}{h(v)}\sum_{b,c}p_u(b|a)p_w(c|a)\tilde\alpha(u,b)\tilde\alpha(w,c) $$
$$ \tilde\beta(u,b)=\frac{1}{h(u)}\sum_{a,c}p_u(b|a)p_w(c|a)\tilde\beta(v,a)\tilde\alpha(w,c) $$
\begin{eqnarray*}
